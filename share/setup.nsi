...
!define MUI_FINISHPAGE_RUN $INSTDIR\populacecoin-qt.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/populacecoin-qt.exe
    File /oname=COPYING.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/populacecoind.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Quark.lnk" $INSTDIR\populacecoin-qt.exe
    ...
    WriteRegStr HKCR "quark" "" "URL:Populacecoin"
    WriteRegStr HKCR "quark\DefaultIcon" "" $INSTDIR\populacecoin-qt.exe
    WriteRegStr HKCR "quark\shell\open\command" "" '"$INSTDIR\populacecoin-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\populacecoin-qt.exe
